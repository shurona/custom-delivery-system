...
public class User extends BaseEntity {
    ...
    @OneToMany
    private List<ChatLog> chatRoomList = new ArrayList<>();  // 들어가 있는 채팅방 목록
    ...
    public void update(UserUpdateRequest request, Long addressCode, double latitude,
        double longitude) {
        ...
        this.detailAddress =
            request.detailAddress() != null ? request.detailAddress() : this.detailAddress;
