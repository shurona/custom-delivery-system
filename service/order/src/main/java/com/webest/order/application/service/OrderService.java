...
import com.webest.order.domain.service.CouponService;
import com.webest.order.domain.service.OrderCouponDomainService;
...
public class OrderService {
    ...
    public OrderResponse createOrder(String userId, UserRole userRole, OrderDto request) {
        ...
        // 상점아이디로 존재하는 상품 검색
        Page<ProductResponse> productResponse = storeService.getProductsByStore(request.storeId(),
            Pageable.unpaged());
     ...
     */
    @Transactional
    public OrderResponse updateOrder(String userId, UserRole userRole, Long orderId,
     ...
     */
    @Transactional
    public Page<OrderResponse> searchOrders(String userId, UserRole userRole,
        OrderSearchDto request, PageRequest pageRequest) {
