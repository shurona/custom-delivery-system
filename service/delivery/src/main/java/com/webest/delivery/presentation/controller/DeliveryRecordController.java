...
public class DeliveryRecordController {
    ...
    public CommonResponse<DeliveryRecordResponse> getDelivery(
        @RequestHeader(name = CommonStaticVariable.X_USER_ID) Long userId,
        ...
        return CommonResponse.success(
            deliveryRecordService.getDeliveryRecord(userId, userRole, deliveryRecordId));
    }


    @GetMapping
    public CommonResponse<List<DeliveryRecordResponse>> getAllDeliveryRecords(
        @RequestHeader(name = CommonStaticVariable.X_USER_ID) Long userId,
        @RequestHeader(name = CommonStaticVariable.X_USER_ROLE) UserRole userRole) {

        return CommonResponse.success(
            deliveryRecordService.getAllDeliveryRecords(userId, userRole));
    }

    @GetMapping("/search")
    public CommonResponse<?> searchDeliveryRecords(
        ...
        return CommonResponse.success(deliveryRecordService.searchDeliveryRecord(userId, userRole,
            deliveryRecordSearchRequest.toDto(), pageRequest));
    }
