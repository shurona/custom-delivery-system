...
public class DeliveryDispatchedEvent {
    ...
    public static DeliveryRecordDto toDeliveryRecordDto(DeliveryDispatchedEvent deliveryDispatchedEvent) {
        return DeliveryRecordDto.create(
                deliveryDispatchedEvent.getId(),
                deliveryDispatchedEvent.getRiderId(),
                deliveryDispatchedEvent.getOrderId(),
                deliveryDispatchedEvent.getDeliveryStatus(),
                deliveryDispatchedEvent.getDeliveryFeeAmount()
        );
    }
}
