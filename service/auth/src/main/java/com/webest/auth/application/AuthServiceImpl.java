...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(AuthRepository authRepository, UserClient userClient,
        RiderClient riderClient, RedisUtil redisUtil, JwtTokenService jwtTokenService,
    ...
    public void logout(String userId) {
        ...
        RefreshTokenDto refreshTokenDto = new RefreshTokenDto(userId, dto.token(),
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        return new User(auth.getUserId(), auth.getPassword(), true, true, true, true,
